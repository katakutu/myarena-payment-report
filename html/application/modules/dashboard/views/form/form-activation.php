...
<!-- BEGIN LOGIN -->
<div class="content">
	<h3 class="form-title">Request Activation Code.</h3>
	<!-- BEGIN FLASH MESSAGE-->
	<div class="row">
		<div class="col-md-12">
			<?php
	...
	<!-- END FLASH MESSAGE-->
	<form action="<?= base_url("{$base_path}/account/activationaction");?>" class="login-form" role="form" id="UserLoginForm" method="post" accept-charset="utf-8">
