			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li class="btn-group">
							<a href="<?= base_url($base_path . '/users/edit/' . (isset($collect['localuser']->seq) ? $collect['localuser']->seq : ''));?>" class="btn green pull-right">
                            ...
                            <table class="table table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<div class="form-group">
												<?= (isset($collect['localuser']->account_address) ? $collect['localuser']->account_address . '<br/>' : '');?>
												...
												<?= (isset($collect['address-values']['city']) ? $collect['address-values']['city'] . '<br/>' : '');?>
