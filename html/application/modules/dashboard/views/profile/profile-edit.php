			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li class="btn-group">
							<a href="<?= base_url($base_path . '/profile/view');?>" class="btn green pull-right">
			...
			<div class="row">
				<div class="col-md-8">
					<div class="box box-primary">
						...
						<form id="users-edit" action="<?= base_url($base_path . '/profile/edit');?>" method="post" role="form" enctype="multipart/form-data">
							<div class="box-body">
								<div class="form-body">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-md-4">
												...
												<div class="row">
													<div class="col-xs-8 image-input-template">
														<img id='user-img-upload' src="<?= (isset($collect['userdata']['account_picture']) ? $collect['userdata']['account_picture'] : '');?>" />
													</div>
