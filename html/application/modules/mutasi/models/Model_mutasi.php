...
class Model_mutasi extends CI_Model {
	...
	function get_transaction_types_to_show() {
		if (isset($this->base_mutasi['transaction_types_to_show'])) {
			$transaction_types = $this->base_mutasi['transaction_types_to_show'];
		} else {
	...
	function massedit_transactions_by_transactionseqs($by_type, $by_value, $transaction_action, $push_params) {
		...
		if (!in_array($transaction_action, $this->base_mutasi['mutasi_actions'])) {
			return false;
		}
		$sql_affected_rows = 0;
